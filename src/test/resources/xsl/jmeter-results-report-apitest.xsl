        ...
        <html>
            <head>
                ...
                <style type="text/css">
                    ...
                    table.details tr th { color: #ffffff; font-weight: bold; text-align:center; background:#2674a6;
        ...
        <table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
            ...
            <xsl:for-each select="/testResults/*[not(@lb = preceding::*/@lb)]">
                ...
                <tr valign="top">
                    ...
                    <td align="center">
                        <a href="">
                            <xsl:attribute name="href"><xsl:text/>javascript:toggle_detail('<xsl:text/><xsl:value-of
                                    select="@lb"/>_detail')
                            </xsl:attribute>
                            <img class="detail_image"
                                 src="data:image/png;base64,"
                                 alt="collapse">
                                <xsl:attribute name="id">
                                    <xsl:text/><xsl:value-of select="@lb"/>_detail_image
                                </xsl:attribute>
                            </img>
                        </a>
                    </td>
        ...
        <xsl:for-each select="/testResults/*[not(@lb = preceding::*/@lb)]">
            <xsl:for-each select="/testResults/*[@lb = current()/@lb]">
                <table align="center" class="details detail" border="0" cellpadding="5" cellspacing="2" width="95%">
                    <xsl:attribute name="id">
                        <xsl:text/><xsl:value-of select="@lb"/>_detail
                    </xsl:attribute>
                    <tr valign="top">
                        <th colspan="2">
                    ...
                    <tr>
                        <td class="key">Sample Count</td>
                        <td>
                            <xsl:value-of select="@sc"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Error Count</td>
                        <td>
                            <xsl:value-of select="@ec"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Response Code</td>
                        <td>
                            <xsl:value-of select="@rc"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Response Message</td>
                        <td>
                            <xsl:value-of select="@rm"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Failure Message</td>
                        <td>
                            <xsl:value-of select="assertionResult/failureMessage"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Method/Url</td>
                        <td>
                            <xsl:value-of select="method"/><xsl:text> </xsl:text><xsl:value-of select="java.net.URL"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Query String</td>
                        <td>
                    ...
                    <tr>
                        <td class="key">Request Headers</td>
                        <td>
                            <xsl:value-of select="requestHeader"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Response Headers</td>
                        <td>
                            <xsl:value-of select="responseHeader"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Response Data</td>
                        <td>
                            <xsl:value-of select="responseData"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key">Response File</td>
                        <td>
